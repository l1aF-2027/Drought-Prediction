...
async def predict(
    ...
    try:
        ...
        pd.DataFrame(x_time_array, columns=features).to_csv('processed_data.csv', index=False)
...
if __name__ == "__main__":
    port = int(os.environ.get("PORT", 7861))  # Hugging Face Spaces sử dụng cổng 7860
